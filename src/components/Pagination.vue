      ...
      <section>
        <div class="flex flex-wrap gap-2 items-center">
          ...
          <button @click="goToPage(Math.max(1, page - 1))" :disabled="page === 1"
            class="itbms-page-prev px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 disabled:opacity-50">◀ Prev</button>
          ...
          <button @click="goToPage(Math.min(totalPage, page + 1))" :disabled="page === totalPage"
            class="itbms-page-next px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 disabled:opacity-50">Next ▶</button>
          <button @click="goToPage(totalPage)" :disabled="page === totalPage"
            class="itbms-page-last px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 disabled:opacity-50">Last ⏭</button>
        </div>
      </section>
    </div>
