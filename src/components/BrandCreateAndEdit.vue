  ...
  <div class="p-6">
    ...
    <div class="bg-blue-50 p-6 rounded-xl shadow-md max-w-xl">
      ...
      <div class="flex space-x-4 mt-6">
        <button @click="handleSave" :disabled="!isSaving || !isFormValid || (prop.mode === 'edit' && !isBrandChanged)"
          id="itbms-save-button" type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
